...
PM_START_TEXT = """
Hello there, I'm [Aleesa🧚‍♀️❤️](https://telegra.ph/file/32ea68c6b2d4f45ffdd26.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add Aleesa to your group 💫", url="t.me/aleesa_4kbot?startgroup=true"
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/32ea68c6b2d4f45ffdd26.jpg)
...
Support them  [₳ⁿuʝα Su̶p̶ul̶s̶a̶r̶a̶ ✰](t.me/Anujasupulsara),[➬ अनुजा⚠️ सुपुलसर❌](t.me/Hacking_Specialist_x),"""
